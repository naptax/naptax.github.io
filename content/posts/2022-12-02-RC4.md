...
Vous trouverez ci-dessous mon implémentation de RC4 en C. Celle-ci n'est pas optimisée et vous en trouverez certainement des meilleures sur le net. Par exemple, je laisse soin au compilateur C de trouver la meilleure optimisation de mes opérations de `modulo` (nous allons vite disséquer/vérifier cela en ASM reversé...) Néanmoins j'estime qu'implémenter soi-meme un RC4 est un exercice intéressant. 
