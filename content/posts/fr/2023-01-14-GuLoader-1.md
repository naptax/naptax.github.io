...
Ce qui va nous intéresser de tracer ici c'est la valeur des registres et de la stack après chaque appel de la fonction (```0x12fc1``` , que nous avons pour plus confort ;-) renommé ```Calcul_XOR```. 
