...
Si vous préférez procéder au déchiffrement du code XORé en **interne dans BINARY NINJA**, plutôt qu'en externe (ici en RUST), alors voici le code Python pour BINARY NINJA:
