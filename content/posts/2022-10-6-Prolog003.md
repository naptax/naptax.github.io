...
Pour nous changer un peu de ce bon vieux GDB ;-) , je vous propose dans cet exemple d'utiliser **mon débogueur en ligne de commande préféré**, le magnifique **`RADARE2`**.
...
Allez, on charge notre vilain binaire sous notre microscope électronique RADARE2:
