...
| Section                    | Données stockées<br/>dans la section | Déclarée dans | Exemple en C    |
|----------------------------|--------------------------------------|---------------|-----------------|
| **.text**                  |                                      | _main()_        | ```int x = 10;``` |
| **.rodata**                |                                      |        _main()_       |                 |
| **.data**                  |                                      |              _main()_ | ```int x = 10;```                |
| **.bss**                   |                                      |  _main()_             | ```int b;```    |
| **HEAP (le tas)**          |                                      |  _main()_             |                 |
| **_shared librairies_**    |                                      |  _main()_             |                 |
| **STACK (la pile)**        |                                      |     _main()_          |                 |
