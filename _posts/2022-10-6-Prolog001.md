...
![../images/memory-full.png](../images/memory-full.png)
...
- Le registre **ESP** stocke l'adresse du dessus de la pile, c'est-à-dire l'adresse de la fin actuelle de la pile du processus en cours. Elle désigne donc **l'adresse la plus basse de la stack**. 
...
Et voilà ci-dessous comment assigner à des registres, les valeurs de nos 3 arguments quand nous sommes **dans** la fonction appelée (*callee*) :
